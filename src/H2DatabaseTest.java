...
public class H2DatabaseTest {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            DeleteDbFiles.execute("~/git/Szoti/h2", "h2", true);
            insertWithStatement();
            DeleteDbFiles.execute("~/git/Szoti/h2", "h2", true);
    ...
    private static void insertWithPreparedStatement() throws SQLException {
        ...
        String CreateQuery = "CREATE TABLE IF NOT EXISTS PERSON(id int primary key, name varchar(255))";
    ...
    private static void insertWithStatement() throws SQLException {
        ...
        try {
            ...
            stmt.execute("INSERT INTO PERSON(id, name) VALUES(4, '" + a + "')");
            stmt.execute("INSERT INTO PERSON(id, name) VALUES(7, 'Sonia')");
            stmt.execute("INSERT INTO PERSON(id, name) VALUES(90, 'Asha')");
